...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='WORKBIT.conf'
CONFIGFOLDER='/root/.WORKBIT'
COIN_DAEMON='WORKBITd'
COIN_CLI='WORKBIT-cli'
COIN_TX='WORKBIT-tx'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/workbit-freelance/Workbit/releases/download/1.0/WORKBIT-CLI-LINUX.zip'
